...
def _fit_single_tree_regressor(args):
...
class RandomForestRegressor:
    def __init__(self, n_trees=10, max_depth=10, min_samples_split=2, n_features=None, n_jobs=None):
    ...
    def fit(self, X, y):
        ...
        with ProcessPoolExecutor(max_workers=self.n_jobs) as executor:
            self.trees = list(executor.map(_fit_single_tree_regressor, args_list))
